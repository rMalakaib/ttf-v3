...
export interface ApiActivityLogActivityLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    beforeJson: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAnswerRevisionAnswerRevision
  extends Struct.CollectionTypeSchema {
  collectionName: 'answer_revisions';
  info: {
    displayName: 'answerRevision';
    pluralName: 'answer-revisions';
    singularName: 'answer-revision';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    auditorReason: Schema.Attribute.Text;
    auditorScore: Schema.Attribute.Decimal;
    auditorSuggestion: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    modelPromptRaw: Schema.Attribute.JSON;
    modelReason: Schema.Attribute.Text;
    modelResponseRaw: Schema.Attribute.JSON;
    modelScore: Schema.Attribute.Decimal;
    modelSuggestion: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.Relation<'manyToOne', 'api::question.question'>;
    revisionIndex: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiFilingFiling extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answer_revisions: Schema.Attribute.Relation<
      'oneToMany',
      'api::answer-revision.answer-revision'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentScore: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    > &
      Schema.Attribute.Required;
    finalizedAt: Schema.Attribute.DateTime;
    finalScore: Schema.Attribute.Decimal;
    firstSubmitAt: Schema.Attribute.DateTime;
    framework_version: Schema.Attribute.Relation<
      'manyToOne',
    ...
    publishedAt: Schema.Attribute.DateTime;
    question_locks: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFrameworkFamilyFrameworkFamily
  extends Struct.CollectionTypeSchema {
  collectionName: 'framework_families';
  info: {
    displayName: 'frameworkFamily';
    pluralName: 'framework-families';
    singularName: 'framework-family';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    framework_versions: Schema.Attribute.Relation<
      'oneToMany',
      'api::framework-version.framework-version'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::framework-family.framework-family'
    > &
      Schema.Attribute.Private;
...
export interface ApiFrameworkVersionFrameworkVersion
  extends Struct.CollectionTypeSchema {
  collectionName: 'framework_versions';
  info: {
    displayName: 'frameworkVersion';
    pluralName: 'framework-versions';
    singularName: 'framework-version';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    framework_family: Schema.Attribute.Relation<
      'manyToOne',
      'api::framework-family.framework-family'
    >;
...
export interface ApiNotificationPreferenceNotificationPreference
  ...
  attributes: {
    ...
    lastPingAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    telegramEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiQuestionLockQuestionLock
  extends Struct.CollectionTypeSchema {
  collectionName: 'question_locks';
  info: {
    displayName: 'questionLock';
    pluralName: 'question-locks';
    singularName: 'question-lock';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    example: Schema.Attribute.Text & Schema.Attribute.Required;
    framework_version: Schema.Attribute.Relation<
      'manyToOne',
      'api::framework-version.framework-version'
    >;
    ...
    modelPrompt: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiSecretKeySecretKey extends Struct.CollectionTypeSchema {
  collectionName: 'secret_keys';
  info: {
    displayName: 'secretKey';
    pluralName: 'secret-keys';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valueHash: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiSubmissionAnswerSubmissionAnswer
  ...
  attributes: {
    answer_revision: Schema.Attribute.Relation<
      'manyToOne',
      'api::answer-revision.answer-revision'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiSubmissionSubmission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    auditorCompleteAt: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filing: Schema.Attribute.Relation<'manyToOne', 'api::filing.filing'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    isNotificationsMuted: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    submissions: Schema.Attribute.Relation<
      ...
      'api::submission.submission'
    >;
    telegramHandle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::answer-revision.answer-revision': ApiAnswerRevisionAnswerRevision;
      'api::client-document.client-document': ApiClientDocumentClientDocument;
      'api::filing.filing': ApiFilingFiling;
      'api::framework-family.framework-family': ApiFrameworkFamilyFrameworkFamily;
      'api::framework-version.framework-version': ApiFrameworkVersionFrameworkVersion;
